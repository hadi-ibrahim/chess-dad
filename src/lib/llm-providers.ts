...
export const PROVIDERS: ProviderMeta[] = [
  {
    ...
    kind: "openai",
    defaultModel: "gpt-5",
    models: ["gpt-5", "gpt-5-mini", "gpt-4.1", "gpt-4.1-mini", "gpt-4o", "o4-mini"],
    ...
    note: "Keys start with sk-. The model list is a hint — type any id OpenAI offers.",
  },
  {
    id: "anthropic",
    ...
    models: ["claude-opus-4-1", "claude-sonnet-4-5", "claude-haiku-4-5", "claude-3-7-sonnet-latest"],
    ...
    supportsThinkingToggle: false,
    note: "Keys start with sk-ant-. Claude has no JSON mode, so the reply is parsed strictly.",
  },
  {
    id: "google",
    label: "Google (Gemini)",
    ...
    supportsJsonMode: true,
    supportsThinkingToggle: false,
    note: "The key is sent as a header, never in the URL, so it cannot leak into a log.",
  },
  {
    id: "deepseek",
    label: "DeepSeek",
